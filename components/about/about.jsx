...
export default function About() {
   return (
      <div
         id="about"
         className="m-[0.5vw] flex flex-col gap-y-[1vw] rounded-[5vw] bg-[#1c1c1c] p-[5vw] py-[2.5vw]"
      >
         <div className="flex items-center">
            <h1 className="flex items-center gap-x-[1vw] text-[6.5vw] font-semibold italic">
               ABO
         ...
         <div className="flex gap-[5vw]">
            ...
            <div className="flex flex-1 gap-x-[2.5vw]">
               <p className="text-[4vw] leading-[1] tracking-tighter">
               ...
               <div className="flex min-w-[30vw] flex-1 justify-end">
                  <div className="max-w-[30vw] text-[1vw] text-gray-300">
                     <p>
