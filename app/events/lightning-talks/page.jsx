      ...
      <div className="flex w-screen gap-x-[2.5vw] p-[5vw]">
         <div>
            <div className="sticky top-[5vw] w-[35vw]">
               <p className="text-[5vw] font-bold">Lightning</p>
